import { CardDefinitions, cardDefinitions, CardId } from './CardDefinitions';
...
export function generateCard(): Card {
    ...
    const cardIds = Object.keys(cardDefinitions) as [keyof CardDefinitions];

    const randomCardDefinitionId = cardIds[randomCardDefinitionIndex];
    if (randomCardDefinitionId === undefined) {
