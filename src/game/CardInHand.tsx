...
export const CardInHand: React.FC<{
    ...
    function clickHandler(e: MouseEvent) {
        ...
        if (e.type === 'click') {
            if (!canCardBePlayed) {
                return; // clicking on unplayable card does nothing
            }
    ...
    return (
        <div
            key={card.id}
            className={`${styles.card} ${canCardBePlayed ? '' : styles.cardNotPlayable}`} // eslint-disable-line @typescript-eslint/restrict-template-expressions
